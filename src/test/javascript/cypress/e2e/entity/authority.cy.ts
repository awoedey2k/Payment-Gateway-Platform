...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '12baaf4c-1a52-4e8b-a87f-0d2e30446ae4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('979bc65d-6762-4a92-b40f-6264d8150b13');
      cy.get(`[data-cy="name"]`).should('have.value', '979bc65d-6762-4a92-b40f-6264d8150b13');
