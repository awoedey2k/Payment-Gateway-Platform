...
import { AmlCheckDeleteDialog } from './aml-check-delete-dialog';

describe('AmlCheck Management Delete Component', () => {
  let comp: AmlCheckDeleteDialog;
  let fixture: ComponentFixture<AmlCheckDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AmlCheckDeleteDialog);
