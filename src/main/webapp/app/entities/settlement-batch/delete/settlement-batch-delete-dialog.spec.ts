...
describe('SettlementBatch Management Delete Component', () => {
  let comp: SettlementBatchDeleteDialog;
  let fixture: ComponentFixture<SettlementBatchDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SettlementBatchDeleteDialog);
