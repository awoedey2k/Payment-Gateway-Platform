...
import { DisputeEvidenceDeleteDialog } from './dispute-evidence-delete-dialog';

describe('DisputeEvidence Management Delete Component', () => {
  let comp: DisputeEvidenceDeleteDialog;
  let fixture: ComponentFixture<DisputeEvidenceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DisputeEvidenceDeleteDialog);
