...
describe('Dispute Management Delete Component', () => {
  let comp: DisputeDeleteDialog;
  let fixture: ComponentFixture<DisputeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DisputeDeleteDialog);
