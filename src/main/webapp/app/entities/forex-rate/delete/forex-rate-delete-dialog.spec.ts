...
import { ForexRateDeleteDialog } from './forex-rate-delete-dialog';

describe('ForexRate Management Delete Component', () => {
  let comp: ForexRateDeleteDialog;
  let fixture: ComponentFixture<ForexRateDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ForexRateDeleteDialog);
