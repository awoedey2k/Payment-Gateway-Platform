...
import { WebhookDeliveryAttemptDeleteDialog } from './webhook-delivery-attempt-delete-dialog';

describe('WebhookDeliveryAttempt Management Delete Component', () => {
  let comp: WebhookDeliveryAttemptDeleteDialog;
  let fixture: ComponentFixture<WebhookDeliveryAttemptDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WebhookDeliveryAttemptDeleteDialog);
