...
import { RoutingRuleDeleteDialog } from './routing-rule-delete-dialog';

describe('RoutingRule Management Delete Component', () => {
  let comp: RoutingRuleDeleteDialog;
  let fixture: ComponentFixture<RoutingRuleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RoutingRuleDeleteDialog);
