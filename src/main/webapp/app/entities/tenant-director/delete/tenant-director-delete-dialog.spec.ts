...
import { TenantDirectorDeleteDialog } from './tenant-director-delete-dialog';

describe('TenantDirector Management Delete Component', () => {
  let comp: TenantDirectorDeleteDialog;
  let fixture: ComponentFixture<TenantDirectorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TenantDirectorDeleteDialog);
