...
describe('Country Management Component', () => {
  ...
  describe('trackId', () => {
    it('should forward to countryService', () => {
      ...
      vi.spyOn(service, 'getCountryIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.countriesParams()).toMatchObject({ sort: ['id,desc'] });
  });
  ...
  it('should calculate the filter attribute', () => {
    ...
    // THEN
    expect(service.countriesParams()).toMatchObject({ 'someId.in': ['dc4279ea-cfb9-11ec-9d64-0242ac120002'] });
  });
