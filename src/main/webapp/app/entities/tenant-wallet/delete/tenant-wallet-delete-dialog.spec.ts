...
import { TenantWalletDeleteDialog } from './tenant-wallet-delete-dialog';

describe('TenantWallet Management Delete Component', () => {
  let comp: TenantWalletDeleteDialog;
  let fixture: ComponentFixture<TenantWalletDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TenantWalletDeleteDialog);
