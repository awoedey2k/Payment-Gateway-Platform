...
import { TenantFeeConfigDeleteDialog } from './tenant-fee-config-delete-dialog';

describe('TenantFeeConfig Management Delete Component', () => {
  let comp: TenantFeeConfigDeleteDialog;
  let fixture: ComponentFixture<TenantFeeConfigDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TenantFeeConfigDeleteDialog);
