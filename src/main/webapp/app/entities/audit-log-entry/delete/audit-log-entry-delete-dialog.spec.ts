...
import { AuditLogEntryDeleteDialog } from './audit-log-entry-delete-dialog';

describe('AuditLogEntry Management Delete Component', () => {
  let comp: AuditLogEntryDeleteDialog;
  let fixture: ComponentFixture<AuditLogEntryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AuditLogEntryDeleteDialog);
