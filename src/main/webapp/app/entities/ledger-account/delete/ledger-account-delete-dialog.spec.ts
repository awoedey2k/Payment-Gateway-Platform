...
import { LedgerAccountDeleteDialog } from './ledger-account-delete-dialog';

describe('LedgerAccount Management Delete Component', () => {
  let comp: LedgerAccountDeleteDialog;
  let fixture: ComponentFixture<LedgerAccountDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LedgerAccountDeleteDialog);
