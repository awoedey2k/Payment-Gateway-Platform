...
describe('Refund Management Delete Component', () => {
  let comp: RefundDeleteDialog;
  let fixture: ComponentFixture<RefundDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RefundDeleteDialog);
