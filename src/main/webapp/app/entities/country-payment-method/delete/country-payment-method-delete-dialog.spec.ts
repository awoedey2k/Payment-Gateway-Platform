...
import { CountryPaymentMethodDeleteDialog } from './country-payment-method-delete-dialog';

describe('CountryPaymentMethod Management Delete Component', () => {
  let comp: CountryPaymentMethodDeleteDialog;
  let fixture: ComponentFixture<CountryPaymentMethodDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CountryPaymentMethodDeleteDialog);
