...
import { PayoutScheduleDeleteDialog } from './payout-schedule-delete-dialog';

describe('PayoutSchedule Management Delete Component', () => {
  let comp: PayoutScheduleDeleteDialog;
  let fixture: ComponentFixture<PayoutScheduleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PayoutScheduleDeleteDialog);
