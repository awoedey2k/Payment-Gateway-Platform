...
import { CorporateTenantDeleteDialog } from './corporate-tenant-delete-dialog';

describe('CorporateTenant Management Delete Component', () => {
  let comp: CorporateTenantDeleteDialog;
  let fixture: ComponentFixture<CorporateTenantDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CorporateTenantDeleteDialog);
