...
/**
 * Criteria class for the {@link io.paymentgateway.core.domain.Currency} entity. This class is used
 * in {@link io.paymentgateway.core.web.rest.CurrencyResource} to receive all the possible filtering options from
...
public class CurrencyCriteria implements Serializable, Criteria {
    ...
    public CurrencyCriteria(CurrencyCriteria other) {
        ...
        this.minorUnit = other.optionalMinorUnit().map(IntegerFilter::copy).orElse(null);
    ...
    public Optional<IntegerFilter> optionalMinorUnit() {
        return Optional.ofNullable(minorUnit);
    }

    public IntegerFilter minorUnit() {
        if (minorUnit == null) {
            setMinorUnit(new IntegerFilter());
        }
        return minorUnit;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, minorUnit, distinct);
    }
    ...
    public String toString() {
        return "CurrencyCriteria{" +
            ...
            optionalMinorUnit().map(f -> "minorUnit=" + f + ", ").orElse("") +
