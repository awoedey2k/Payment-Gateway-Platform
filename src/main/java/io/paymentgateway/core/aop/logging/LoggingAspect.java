package io.paymentgateway.core.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(io.paymentgateway.core.repository..*)
        || within(io.paymentgateway.core.service..*)
        || within(io.paymentgateway.core.web.rest..*)
        """
    )
